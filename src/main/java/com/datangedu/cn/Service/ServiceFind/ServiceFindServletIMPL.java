...
public class ServiceFindServletIMPL implements ServiceFindServlet {
	...
	public int serviceFind(HttpServletRequest request) throws NoSuchAlgorithmException, UnsupportedEncodingException {
		...
		serviceprovider.setServProviderPassword(md5.EncoderByMd5(request.getParameter("newpassword")));
		...
		return serviceproviderMapper.updateByExampleSelective(serviceprovider, serviceproviderExample);
