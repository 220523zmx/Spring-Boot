...
public class ControllerCustomerRegister {
	...
	public Map<String,Object> register(HttpServletRequest request)
	{
		  ...
		  switch(state)
		  {
			  case 10:map.put("state", "请输入验证码");map.put("state", "");break;
			  ...
			  case 41:map.put("state", "请选择正确地址~");break;
			  case 42:map.put("state", "请选择正确地址~");break;
			  case 43:map.put("state", "请选择正确地址~");break;
			  case 1 :map.put("state", "注册成功");break;
			  default :map.put("state", "注册失败");break;
		  }
		  return map;
	}
}
